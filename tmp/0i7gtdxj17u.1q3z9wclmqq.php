                      ...
                      - data-toggle="jpanel-menu" = jPanel Menu
                        ...
                        <div class="navbar-collapse collapse"> 
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="<?php echo $signinstatuslink; ?>"><?php echo $signinstatus; ?></a></li>
                                <!--<li><a href="#"><?php echo $signinstatuslink; ?></a></li>
                                <li><a href="#"><?php echo $signinstatus2; ?></a></li>-->
                                <li><a href="<?php echo $signinstatuslink2; ?>"><?php echo $signinstatus2; ?></a></li>
